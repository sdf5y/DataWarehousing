...
print(data_df.describe().round(0))
print(data_df.shape)
data_df.dtypes
...
#%% Create fake user artist histories
...
model = glm(formula='explicit ~ popularity + energy + speechiness', 
            data = df_artists, family = sm.families.Binomial())
